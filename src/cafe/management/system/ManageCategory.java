...
//to show all categories added on the Table
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        int a = JOptionPane.showConfirmDialog(null, "<html><b style=\"color:Red\">Do you want to Delete </b><b>" + name + "</b><b style=\"color:Red\"> Category ❓</b></html>", "Select", JOptionPane.YES_NO_CANCEL_OPTION);
        if (a == 0) {
